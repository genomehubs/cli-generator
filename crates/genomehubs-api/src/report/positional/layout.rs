...
pub fn order_sequences_by_median(
    ...
    ref_cumulative: &std::collections::HashMap<String, u64>,
    group_to_ref_pos: &std::collections::HashMap<String, u64>,
    seq_to_groups: &std::collections::HashMap<String, Vec<String>>,
) -> Vec<SequenceLayout> {
...
fn median_ref_score(
    ...
    group_to_ref_pos: &std::collections::HashMap<String, u64>,
    _ref_cumulative: &std::collections::HashMap<String, u64>,
) -> f64 {
...
mod tests {
    ...
    fn orient_positive_slope() {
        // Points with positive slope → orientation +1
    ...
    fn orient_negative_slope() {
        // Points with negative slope → orientation -1
